...
INSERT INTO `fieldrouter` (`id`, `longitude`, `latitude`, `routername`, `lastsynctime`, `displayname`, `targetsensorname`) VALUES (1,136.8725,34.907167,'vbox0094','2014-08-13 16:39:48','半田','HandaMet'),(2,140.218666666667,35.7318333333333,'vbox0115','2014-08-13 16:39:50','印旛沼1','inba1'),(3,140.205166666667,35.7423333333333,'vbox0116','2014-08-13 16:39:52','印旛沼2','inba2');
...
INSERT INTO `contacttype` (`label`, `id`) VALUES ('電話番号',1),('住所',2),('E-mail',3),('携帯電話',4);
...
INSERT INTO `displayfielddata` (`id`, `fieldrouterid`, `fielddatatype`, `displaylabel`, `valueoffset`, `isdouble`, `valuefactor`, `valueunit`) VALUES (1,1,'Timestamp','撮影日時','0',NULL,'1','度'),(2,1,'Port2','気温',NULL,NULL,NULL,NULL);
...
INSERT INTO `postcategory` (`parent`, `id`, `label`) VALUES (0,1,'作業記録'),(0,2,'公開'),(0,3,'問い合わせ'),(3,4,'漏水'),(0,5,'その他'),(0,6,'会場'),(0,7,'いきもの');
...
INSERT INTO `poststatus` (`id`, `label`, `availabletransition`) VALUES (1,'Not start','2'),(2,'progress','');
...
-- Dump completed on 2015-10-24  3:35:23
